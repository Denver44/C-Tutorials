...
// {
//     FILE *ptr;
//     ptr = fopen("C84.dat", "wb"); // creating a file in a binary mode so taht we can write it in binary form
...
//     fwrite(class, sizeof(struct student_record), 5, ptr); //fwrite fucntion is for the binary mode.
